...
NGL.MenubarWidget = function (stage, preferences) {
  ...
  container.add(
    new UI.Panel().setClass('menu').setFloat('right').add(
      new UI.Text('B R E A K I N G * β α ∆ ').setClass('title')
    )
  )
...
NGL.MenubarFileWidget = function (stage) {
  ...
  return UI.MenubarHelper.createMenuContainer('F I L E', optionsPanel)
}
...
NGL.MenubarViewWidget = function (stage, preferences) {
  ...
  return UI.MenubarHelper.createMenuContainer('V I E W', optionsPanel)
}
...
NGL.OverviewWidget = function (stage, preferences) {
  ...
  headingPanel.add(
    new UI.Text('B R E A K I N G / B A D').setFontStyle('italic'),
